...
module.exports = "\n\n\n\n\n<div class=\"container\">\n    <button class=\"btn btn-primary\" *ngFor=\"let city of cities\" [routerLink]=\"['/'+route]\">{{ city.name }}</button>\n    <router-outlet></router-outlet>\n\n\n</div>\n\n"
...
const routes = [
    { path: ':cityRoute', component: _city_city_component__WEBPACK_IMPORTED_MODULE_3__["CityComponent"] }
];
...
let AppComponent = class AppComponent {
    ...
    constructor(_httpService, _router) {
        ...
        this.cities = [
            ...
            { name: 'San Jose', route: 'sanjose', id: 4673475 },
