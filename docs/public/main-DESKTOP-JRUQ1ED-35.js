...
let CityComponent = class CityComponent {
    constructor(_route, _router, _httpService) {
        ...
        this.cityRoutes = {
            ...
            'dallas': { name: 'Dallas', id: 4684888, image: '' },
            'dc': { name: 'Washington, DC', id: 4366164, image: '' },
            'sanjose': { name: 'San Jose', id: 5392171, image: '' },
            'seattle': { name: 'Seattle', id: 5809844, image: '' },
        };
    }
    ngOnInit() {
        this.weather = {
