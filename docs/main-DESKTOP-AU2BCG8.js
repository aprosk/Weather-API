...
module.exports = "\n\n\n\n\n<div class=\"container\">\n    <button class=\"btn btn-primary\" *ngFor=\"let city of cities\" [routerLink]=\"['/'+city.route]\">{{ city.name }}</button>\n    <router-outlet></router-outlet>\n\n\n</div>\n\n"
...
module.exports = "<h1>{{cityName}}</h1>\n<p>{{weather | json}}</p>\n\n<img *ngFor=\"let condition of weather.conditions\" [src]=\"getIcon(condition.icon)\">"
...
let AppComponent = class AppComponent {
    ...
    constructor(_httpService, _router) {
        ...
        this.cities = [
            { name: 'Burbank', route: 'burbank', id: 5331835 },
            { name: 'Chicago', route: 'chicago', id: 4887398 },
            { name: 'Dallas', route: 'dallas', id: 4684888 },
            { name: 'Washington, DC', route: 'dc', id: 4366164 },
            { name: 'San Jose', route: 'sanjose', id: 5392171 },
            { name: 'Seattle', route: 'seattle', id: 5809844 },
        ];
    }
    ngOnInit() {
    }
