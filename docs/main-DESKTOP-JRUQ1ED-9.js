...
let CityComponent = class CityComponent {
    constructor(_route, _router, _httpService) {
        ...
        this.cityRoutes = {
            'burbank': { name: 'Burbank, CA', id: 5331835 },
            'chicago': { name: 'Chicago, IL', id: 4887398 },
            'dallas': { name: 'Dallas, TX', id: 4684888 },
            'dc': { name: 'Washington, DC', id: 4366164 },
            'sanjose': { name: 'San Jose, CA', id: 5392171 },
            'seattle': { name: 'Seattle, WA', id: 5809844 },
        };
    }
    ngOnInit() {
        this.weather = {
